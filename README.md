...
First touch with a scripting language like **JavaScript**. It was also the first time learning about **JSON**.  

Final Grade: 17

For the second part of the subject follow [this](https://github.com/ShadowXPAEdu/tpsi-web-programming-ii) link.
